...
const formatarData = (dataString) => {
    ...
    try {
        ...
        if (isNaN(data.getTime())) return dataString; // Retorna a string se for Inválida
...
function ModalGerenciar({ onClose, manifestacao, onSaveResponse, readOnly = false, adminSetor }) {
    ...
    if (!readOnly) { 
        switch (adminSetorNormalizado) {
            ...
            case 'informatica':
                if (
                    setorManifestacaoNormalizado === 'informatica' || 
                    setorManifestacaoNormalizado === 'manufatura digital' || // Adicionado: Admin Info edita Manufatura
                    setorManifestacaoNormalizado === 'geral'
                ) {
                    podeEditarPelaRegra = true;
                }
                break;
            case 'mecanica':
                if (setorManifestacaoNormalizado === 'mecanica' || setorManifestacaoNormalizado === 'geral') {
                    podeEditarPelaRegra = true;
                }
                break;
            case 'manufatura digital': // NOVO ADMIN
                if (setorManifestacaoNormalizado === 'manufatura digital' || setorManifestacaoNormalizado === 'geral') {
                    podeEditarPelaRegra = true;
                }
                break;
            case 'analista de qualidade de vida': // NOVO ADMIN
                if (setorManifestacaoNormalizado === 'analista de qualidade de vida' || setorManifestacaoNormalizado === 'geral') {
                    podeEditarPelaRegra = true;
                }
                break;
            default:
    ...
    const imagemSrc = manifestacao.anexoBase64 || manifestacao.imagemBase64 || manifestacao.imagem || manifestacao.caminhoAnexo;
    ...
    const contentEditing = [
        ...
        e('label', { key: 'label-setor' }, [
            ...
            e('select', {
                ...
                e('option', { key: 'set-info', value: 'Informática' }, 'Informática'),
                e('option', { key: 'set-mec', value: 'Mecânica' }, 'Mecânica'),
                e('option', { key: 'set-manuf', value: 'Manufatura Digital' }, 'Manufatura Digital'), // NOVO
                e('option', { key: 'set-aqv', value: 'Analista de Qualidade de Vida' }, 'Analista de Qualidade de Vida'), // NOVO
    ...
    const contentView = [
        ...
        // CORREÇÃO: Formatação da data da resposta
        e('p', { key: 'data-resposta' }, [e('strong', null, 'Data da Resposta: '), formatarData(manifestacao.dataResposta)]),
        ...
        e(
            ...
            [
                ...
                e('div', { key: 'body', className: 'modal-body' }, [
                    e('p', { key: 'nome' }, [e('strong', null, 'Nome: '), manifestacao.nome || 'Anônimo']),
                    e('p', { key: 'contato' }, [e('strong', null, 'Contato: '), manifestacao.contato || 'Anônimo']),
